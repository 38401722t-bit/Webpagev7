...
const STATE_FOODS: Record<string, string[]> = {
  "Andhra Pradesh": [
    "Tirupati Laddu",
    "Gongura Pachadi",
    "Pootharekulu",
...
export const PRESET_ROUTES: PresetRoute[] = [
  {
    ...
    region: "North",
    days: 6,
    stops: ["dl-delhi", "up-agra", "rj-jaipur"],
    image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=800",
    tag: "Heritage & Royalty",
    description: "India's definitive classic route covering Mughal grandeur, timeless marble wonders, and Rajasthani palaces.",
  },
  {
    id: "route-kerala-backwaters",
    name: "Kerala Emerald Trail",
    subtitle: "Kochi · Munnar · Alleppey",
    region: "South",
    days: 7,
    stops: ["kl-kochi", "kl-munnar", "kl-alleppey"],
    image: "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?w=800",
    tag: "Nature & Serenity",
    description: "Misty tea hills, tranquil backwater houseboats, and coastal colonial heritage in God's Own Country.",
  },
  {
    id: "route-royal-rajasthan",
    name: "Royal Fortress Odyssey",
    subtitle: "Jaipur · Jodhpur · Udaipur",
    region: "West",
    days: 8,
    stops: ["rj-jaipur", "rj-jodhpur", "rj-udaipur"],
    image: "https://images.unsplash.com/photo-1599661046827-dacff0c0f09a?w=800",
    tag: "Palaces & Forts",
    description: "Immerse in the colorful Rajput legacy across pink sandstone ramparts, blue alleyways, and shimmering lake palaces.",
  },
  {
    id: "route-deccan-heritage",
    name: "Deccan & Coastal Expedition",
    subtitle: "Hyderabad · Hampi · Goa",
    region: "South-Central",
    days: 9,
    stops: ["ka-hampi", "ga-north-goa", "ga-south-goa"],
    image: "https://images.unsplash.com/photo-1600100397608-f010f443b236?w=800",
    tag: "Ruins & Sunset Shores",
    description: "Journey through UNESCO stone chariot ruins, boulder-strewn rivers, and sun-kissed Arabian Sea beaches.",
  },
];
